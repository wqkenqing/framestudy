...
public class TestCrawler extends BreadthCrawler {
    ...
    public TestCrawler(String crawlPath, boolean autoParse) {
        ...
        /*种子页面*/
        this.addSeed("http://www.aust.edu.cn");
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        /*判断是否为新闻页，通过正则可以轻松判断*/
        if (page.matchUrl("http://www.aust.edu.cn/.*htm")) {
...
//            String title = page.select("div[id=Article]>h2").first().text();
            String content = page.select("div#vsb_content_1330_u111", 0).text();
...
//            System.out.println("title:\n" + title);
    ...
    public static void main(String[] args) throws Exception {
        TestCrawler crawler = new TestCrawler("crawl", true);
        /*线程数*/
